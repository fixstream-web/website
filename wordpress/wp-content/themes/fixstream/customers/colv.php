...
<head>
	...
	<?php wp_head(); ?>
	<link rel="stylesheet" href="/wp-content/themes/fixstream/css/customers/colv.css">
	<script type="text/javascript" src="/wp-content/themes/fixstream/js/head.js" rel="preload" as="script"></script></head>
<body class="page-customers page-customers-colv">
...
<nav class="globalnav">
		...
		<div class="pageheader">
			<h1 class="pageheader-headline">COLV</h1>
		</div>
