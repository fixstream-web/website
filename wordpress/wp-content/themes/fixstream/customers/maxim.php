...
<head>
	...
	<?php wp_head(); ?>
	<link rel="stylesheet" href="/wp-content/themes/fixstream/css/customers/maxim.css">
	<script type="text/javascript" src="/wp-content/themes/fixstream/js/customers/maxim.js"></script>
</head>
<body class="page-customers page-customers-maxim">
...
<nav class="globalnav">
			<ul class="globalnav__toplevel">
				<li class="globalnav__item with-subnav">
					<a class="globalnav__link" href="/platform">Platform</a>
						<input
							type="checkbox"
							id="subnavToggle-51[object Object]"
							class="globalnav__subnav-toggle hidden"
							name="platform"
						 /><label class="globalnav__subnav-button" for="subnavToggle-51[object Object]">+</label>						<ul class="globalnav__subnav">
		        		...
		        		<input
		        			type="checkbox"
		        			id="subnavToggle-52[object Object]"
		        			class="globalnav__subnav-toggle hidden"
		        			name="ecosystem"
		        		 /><label class="globalnav__subnav-button" for="subnavToggle-52[object Object]">+</label>								<ul class="globalnav__subnav">
						<li class="globalnav__item">
				...
				<li class="globalnav__item with-subnav">
					<a class="globalnav__link" href="/customers">Customers</a>
						<input
							type="checkbox"
							id="subnavToggle-53[object Object]"
							class="globalnav__subnav-toggle hidden"
							name="customers"
						 /><label class="globalnav__subnav-button" for="subnavToggle-53[object Object]">+</label>						<ul class="globalnav__subnav">
						<li class="globalnav__item">
		...
		<div class="pageheader">
			<h1 class="pageheader-headline">Maxim</h1>
		</div>
