...
<html class="no-js">
<head>
	<title>Fixstream | Architecture</title>
	...
	<?php wp_head(); ?>
	<link rel="stylesheet" href="/wp-content/themes/fixstream/css/platform/architecture.css">
	<script type="text/javascript" src="/wp-content/themes/fixstream/js/platform/architecture.js"></script>
</head>
<body class="page-platform page-platform-architecture">
...
<nav class="globalnav">
			<ul class="globalnav__toplevel">
				<li class="globalnav__item with-subnav">
					<a class="globalnav__link" href="/platform">Platform</a>
						<input
							type="checkbox"
							id="subnavToggle-57[object Object]"
							class="globalnav__subnav-toggle hidden"
							name="platform"
						 /><label class="globalnav__subnav-button" for="subnavToggle-57[object Object]">+</label>						<ul class="globalnav__subnav">
		        		...
		        		<input
		        			type="checkbox"
		        			id="subnavToggle-58[object Object]"
		        			class="globalnav__subnav-toggle hidden"
		        			name="ecosystem"
		        		 /><label class="globalnav__subnav-button" for="subnavToggle-58[object Object]">+</label>								<ul class="globalnav__subnav">
						<li class="globalnav__item">
				...
				<li class="globalnav__item with-subnav">
					<a class="globalnav__link" href="/customers">Customers</a>
						<input
							type="checkbox"
							id="subnavToggle-59[object Object]"
							class="globalnav__subnav-toggle hidden"
							name="customers"
						 /><label class="globalnav__subnav-button" for="subnavToggle-59[object Object]">+</label>						<ul class="globalnav__subnav">
						<li class="globalnav__item">
		...
		<div class="pageheader">
			<h1 class="pageheader-headline">Architecture</h1>
		</div>
